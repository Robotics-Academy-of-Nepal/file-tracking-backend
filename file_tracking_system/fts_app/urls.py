...
from .views import UserViewSet, get_provinces, get_districts, get_municipalities, TippaniViewSet, \
    LettersAndDocumentsViewSet, FileViewSet, DesignationViewSet, ApprovalViewSet
